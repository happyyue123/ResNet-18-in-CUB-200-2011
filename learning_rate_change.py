...
class LitModel(LightningModule):
    ...
    def configure_optimizers(self):
        ...
        '''def lr_lambda(epoch):
            if epoch < 10:
                return 1.0  # 0-10个epoch，学习率保持为0.01
            else:
                return 0.1  # 10-20个epoch，学习率为0.001 (0.01 * 0.1)
            
        
        scheduler = optim.lr_scheduler.LambdaLR(optimizer, lr_lambda)'''
        return optimizer

learning_rate = 0.01  # 初始学习率设为0.01
batch_size = 32
num_epochs = 20
optimizer_name = "SGD"
weight_decay = 0.0002
...
logger = TensorBoardLogger("/mnt/ly/models/wy/results", name="learning rate = 0.01 (1-10 epochs) and =0.001 (11-20 epochs)")
...
torch.save(best_model.model.state_dict(), '/mnt/ly/models/wy/models/best_model_weights.pth')
# 启动 TensorBoard
